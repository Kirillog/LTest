...
* Поддерживать ли минимизацию блокирующих структур?
* Может лучше добавить std::conditional_variable и std::semaphore для полноты?
* Лучше потестить fairness мьютексов
* Добавить отлов дедлоков (непонятно как)